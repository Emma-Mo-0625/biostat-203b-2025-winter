...
ggplot() +
  ...
  guides(
      color = guide_legend(order = 1, title = "Care Unit"),
      linewidth = guide_legend(order = 2, title = "ICU/CCU"),
      shape = guide_legend(order = 3, title = "Procedure")
    )
