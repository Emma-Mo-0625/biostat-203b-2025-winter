...
labevents_tble <- tbl(con_bq, "labevents") |>
  ...
  # filter(subject_id %in% dplyr::pull(icustays_tble, subject_id)) |>
  # filter(itemid %in% c(50912, 50971, 50983, 50902, 50882, 51221, 51301, 50931)) |>
  # filter(storetime < icustays_tble$intime) |>
  group_by(subject_id, stay_id, itemid) |>
  slice_max(storetime) |>
  ungroup() |>
  select(-intime, -first_careunit, -last_careunit, -outtime, -los, -stay_id) |>
  # show_query() |>
  # collect() |>
  # arrange(subject_id, hadm_id) |>
  print()
